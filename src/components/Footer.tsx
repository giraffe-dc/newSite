        ...
        <footer className={styles.footer}>
            <div className="container">
                <div className={styles.footerContent}>
                    <div className={styles.footerSection}>
                        ...
                        <p>
                            Сімейний розважальний центр для незабутніх моментів
                            з родиною. Створюємо радість для дітей та дорослих!
                        </p>
                        {renderSocialLinks()}
                    </div>
            ...
            <p>📸 Фотозона</p> */}
                ...
                <div className={styles.footerBottom}>
                    <p>
                        &copy; 2025 Жирафик. Всі права захищені. Створено з ❤️
                        для сімей України.
                    </p>
                </div>
            </div>
